...
describe('CustomResourceManager', () => {
  ...
  describe('_createResource', () => {
    it('creates custom resource', async () => {
      ...
      expect(v1beta1Mock.customresourcedefinitions.post).to.have.been.calledWith({
  ...
  describe('_getResource', () => {
    it('gets custom resource', async () => {
      ...
      expect(v1beta1Mock.customresourcedefinitions).to.have.been.calledWith(fakeResourceName)
      expect(v1beta1Mock.customresourcedefinitions.get).to.have.callCount(1)
    })
  })
  ...
  describe('_updateResource', () => {
    it('updates custom resource', async () => {
      ...
      expect(v1beta1Mock.customresourcedefinitions).to.have.been.calledWith(fakeResourceName)
      expect(v1beta1Mock.customresourcedefinitions.put).to.have.been.calledWith({
        body: fakeCustomResourceManifest
      })
    })
  })
  ...
  describe('upsertResource', () => {
    ...
    it('creates custom resource', async () => {
      ...
      await customResourceManager.upsertResource({
        customResourceManifest: fakeCustomResourceManifest
      })

      expect(loggerMock.info.calledWith(logInfoMsg))
      expect(kubeClientMock.addCustomResourceDefinition).to.have.been.calledWith(fakeCustomResourceManifest)
      expect(customResourceManager._createResource).to.have.been.calledWith({
        customResourceManifest: fakeCustomResourceManifest
      })
      expect(customResourceManager._getResource).to.have.callCount(0)
      expect(customResourceManager._updateResource).to.have.callCount(0)
    })
    ...
    it('updates custom resource', async () => {
      ...
      expect(customResourceManager._getResource).to.have.been.calledWith({
        resourceName: fakeResourceName
      })
      expect(customResourceManager._updateResource).to.have.been.calledWith({
        customResource: fakeCustomResource,
        customResourceManifest: fakeCustomResourceManifest
      })
      expect(customResourceManager._sleep).to.have.callCount(0)
    })
  })
})
